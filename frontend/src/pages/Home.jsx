...
const Home = () => {
  ...
  <div>
    ...
    <div style={{display: "flex", flexDirection: "column", height: "calc(100vh - 61px)",marginTop:"61px",backgroundColor:"#030303"}}>
      <div className='Hero' style={{color:"white",display:"flex",height:"40vh",alignContent:"flex-start",justifyContent:"space-around"}}>
        <div style={{display:"flex",flexDirection:"column","alignItems":"flex-start",justifyContent:"center"}}>
          <div style={{position:"relative",left:"0px",marginTop:"5vh"}}>
            Your Growth, Our Goal.
          </div>
          <div style={{position:"relative",fontFamily: "'Algance', sans-serif",left:"0px",fontSize:"3rem",fontWeight:"bold"}}>
            How it Works?          
          </div>
          <div style={{fontFamily: "'Algance', sans-serif",position:"relative",left:"0px",fontSize:"18px",fontWeight:"normal",paddingTop:"5vh"}}>
            <p style={{fontFamily: "'Algance', sans-serif"}}>We are all about you. Helping you adopt sustainable habits</p> 
            <p style={{fontFamily: "'Algance', sans-serif"}}>through engaging activities, tracking your progress, and rewarding your efforts.</p>    
          </div>
        </div>
        <div>
